...
We can use a different python routine to fit a curvy equation like this.  We will use the scipy optimize curve\_fit() routine. But we can help the curve\_fit() routine a little by adding in an extra part to our equation. Let's code our fit equation like this
...
I suppose we could have just used the theory variables like $\Delta V_{max}$ in python. you might choose to do that.

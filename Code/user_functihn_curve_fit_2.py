...
#  arrays. Let's say our data is voltage vs. time. Put the time
#  values in the xdata array and the voltage values in the 
#  ydata array. For the exmple the units are seconds and volts
...
#we also need the ydata uncertainty for error bars. Let's say 
#  it is 0.2V
ydata_err = 0.2 #V
...
plt.errorbar(xdata, ydata, yerr = ydata_err, label ='data', fmt='ro')
